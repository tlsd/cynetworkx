...
from cynetworkx.utils import is_string_like
from cynetworkx.drawing.layout import shell_layout, \
    circular_layout, kamada_kawai_layout, spectral_layout, \
    spring_layout, random_layout

__all__ = ['draw',
           'draw_cynetworkx',
           'draw_cynetworkx_nodes',
           'draw_cynetworkx_edges',
           'draw_cynetworkx_labels',
           'draw_cynetworkx_edge_labels',
           'draw_circular',
           'draw_kamada_kawai',
           'draw_random',
           'draw_spectral',
...
def draw(G, pos=None, ax=None, **kwds):
    ...
    and no axis labels by default.  See draw_cynetworkx() for more
    ...
    pos : dictionary, optional
       ...
       See :py:mod:`cynetworkx.drawing.layout` for functions that
    ...
    kwds : optional keywords
       See cynetworkx.draw_cynetworkx() for a description of optional keywords.
    ...
    >>> import cynetworkx as nx
    >>> G = nx.dodecahedral_graph()
    >>> nx.draw(G)  # cynetworkx draw()
    >>> plt.draw()  # pyplot draw()

    Also see the NetworkX drawing examples at
    https://cynetworkx.github.io/documentation/latest/auto_examples/index.html
    """
    try:
        import matplotlib.pyplot as plt
    except ImportError:
    ...
    try:
        draw_cynetworkx(G, pos=pos, ax=ax, **kwds)
        ax.set_axis_off()
...
def draw_cynetworkx(G, pos=None, arrows=True, with_labels=True, **kwds):
    ...
    node_collection = draw_cynetworkx_nodes(G, pos, **kwds)
    edge_collection = draw_cynetworkx_edges(G, pos, arrows=arrows, **kwds)
    if with_labels:
        draw_cynetworkx_labels(G, pos, **kwds)
    plt.draw_if_interactive()


def draw_cynetworkx_nodes(G, pos,
                        nodelist=None,
                        node_size=300,
                        node_color='r',
                        node_shape='o',
    ...
    --------
    >>> G = nx.dodecahedral_graph()
    >>> nodes = nx.draw_cynetworkx_nodes(G, pos=nx.spring_layout(G))
...
def draw_cynetworkx_edges(G, pos,
                        edgelist=None,
                        width=1.0,
                        edge_color='k',
                        style='solid',
    ...
    --------
    >>> G = nx.dodecahedral_graph()
    >>> edges = nx.draw_cynetworkx_edges(G, pos=nx.spring_layout(G))

    >>> G = nx.DiGraph()
    >>> G.add_edges_from([(1, 2), (1, 3), (2, 3)])
    >>> arcs = nx.draw_cynetworkx_edges(G, pos=nx.spring_layout(G))
    >>> alphas = [0.3, 0.4, 0.5]
...
def draw_cynetworkx_labels(G, pos,
                         labels=None,
                         font_size=12,
                         font_color='k',
    ...
    --------
    >>> G = nx.dodecahedral_graph()
    >>> labels = nx.draw_cynetworkx_labels(G, pos=nx.spring_layout(G))
...
def draw_cynetworkx_edge_labels(G, pos,
                              edge_labels=None,
                              label_pos=0.5,
                              font_size=10,
                              font_color='k',
    ...
    --------
    >>> G = nx.dodecahedral_graph()
    >>> edge_labels = nx.draw_cynetworkx_edge_labels(G, pos=nx.spring_layout(G))
...
def draw_shell(G, **kwargs):
    """Draw cynetworkx graph with shell layout.
...
def apply_alpha(colors, alpha, elem_list, cmap=None, vmin=None, vmax=None):
    ...
    elem_list : array of cynetworkx objects
