...
from cynetworkx.algorithms import isomorphism as iso
...
class TestAtlas(object):
    ...
    def setupClass(cls):
        ...
        import cynetworkx.generators.atlas as atlas
...
def test_isomorphism_iter1():
    # As described in:
    # http://groups.google.com/group/cynetworkx-discuss/browse_thread/thread/2ff65c67f5e3b99f/d674544ebea359bb?fwc=1
    g1 = nx.DiGraph()
    g2 = nx.DiGraph()
    g3 = nx.DiGraph()
    g1.add_edge('A', 'B')
