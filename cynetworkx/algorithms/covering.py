...
from cynetworkx.utils import not_implemented_for, arbitrary_element
...
def min_edge_cover(G, matching_algorithm=None):
    ...
    matching_algorithm : function
        ...
        :func:`~cynetworkx.algorithms.bipartite.matching.hopcroft_karp_matching`
        will be used. Other possibilities include
        :func:`~cynetworkx.algorithms.bipartite.matching.eppstein_matching`,
        or matching algorithms in the
        :mod:`cynetworkx.algorithms.matching` module.
    ...
    function present in :mod:`cynetworkx.algorithms.bipartite.covering`
    """
