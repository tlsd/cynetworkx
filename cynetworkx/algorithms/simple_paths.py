...
def all_simple_paths(G, source, target, cutoff=None):
    ...
    :func:`cynetworkx.utils.pairwise` helper function::
...
def _bidirectional_shortest_path(G, source, target,
    ...
    path implementation at cynetworkx.algorithms.unweighted
...
def _bidirectional_dijkstra(G, source, target, weight='weight',
    ...
    shortest path implementation at cynetworkx.algorithms.weighted
