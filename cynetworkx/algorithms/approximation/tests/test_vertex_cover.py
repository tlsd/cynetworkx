...
from cynetworkx.algorithms.approximation import min_weighted_vertex_cover
...
class TestMWVC(object):
    ...
    function,
    :func:`~cynetworkx.algorithms.approximation.vertex_cover.min_weighted_vertex_cover`.
