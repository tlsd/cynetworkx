...
# information.
"""Unit tests for the :mod:`cynetworkx.algorithms.approximation.clique`
module.
...
from cynetworkx.algorithms.approximation import max_clique
from cynetworkx.algorithms.approximation import clique_removal
from cynetworkx.algorithms.approximation import large_clique_size
...
class TestCliqueRemoval(object):
    """Unit tests for the
    :func:`~cynetworkx.algorithms.approximation.clique_removal` function.
...
class TestMaxClique(object):
    """Unit tests for the :func:`cynetworkx.algorithms.approximation.max_clique`
    function.
