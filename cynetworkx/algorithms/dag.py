...
from cynetworkx.generators.trees import NIL
from cynetworkx.utils import arbitrary_element
from cynetworkx.utils import consume
from cynetworkx.utils import pairwise
from cynetworkx.utils import generate_unique_node
...
def dag_to_branching(G):
    ...
    As described in :mod:`cynetworkx.algorithms.tree.recognition`, a
    ...
    *arborescences*. For this function, each node of in-degree zero in
    ...
    :func:`cynetworkx.convert_node_labels_to_integers` function.

    The current implementation of this function uses
    :func:`cynetworkx.prefix_tree`, so it is subject to the limitations of
    that function.
