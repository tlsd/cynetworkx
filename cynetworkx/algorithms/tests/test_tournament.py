...
# information.
"""Unit tests for the :mod:`cynetworkx.algorithms.tournament` module."""
...
from cynetworkx import DiGraph
from cynetworkx.algorithms.tournament import is_reachable
from cynetworkx.algorithms.tournament import is_strongly_connected
from cynetworkx.algorithms.tournament import is_tournament
from cynetworkx.algorithms.tournament import random_tournament
from cynetworkx.algorithms.tournament import hamiltonian_path


class TestIsTournament(object):
    """Unit tests for the :func:`cynetworkx.tournament.is_tournament`
    function.
...
class TestRandomTournament(object):
    """Unit tests for the :func:`cynetworkx.tournament.random_tournament`
    function.
...
class TestHamiltonianPath(object):
    """Unit tests for the :func:`cynetworkx.tournament.hamiltonian_path`
    function.
    ...
    def test_hamiltonian_cycle(self):
        """Tests that :func:`cynetworkx.tournament.hamiltonian_path`
...
class TestReachability(object):
    """Unit tests for the :func:`cynetworkx.tournament.is_reachable`
    function.
...
class TestStronglyConnected(object):
    """Unit tests for the
    :func:`cynetworkx.tournament.is_strongly_connected` function.
