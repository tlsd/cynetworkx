...
from cynetworkx.algorithms.simple_paths import _bidirectional_shortest_path
from cynetworkx.algorithms.simple_paths import _bidirectional_dijkstra
from cynetworkx.utils import arbitrary_element


class TestIsSimplePath(object):
    """Unit tests for the
    :func:`cynetworkx.algorithms.simple_paths.is_simple_path` function.
