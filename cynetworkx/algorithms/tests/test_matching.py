...
from cynetworkx.algorithms.matching import matching_dict_to_set
from cynetworkx.testing import assert_edges_equal


class TestMaxWeightMatching(object):
    """Unit tests for the
    :func:`~cynetworkx.algorithms.matching.max_weight_matching` function.
...
class TestIsMatching(object):
    """Unit tests for the
    :func:`~cynetworkx.algorithms.matching.is_matching` function.
...
class TestIsMaximalMatching(object):
    """Unit tests for the
    :func:`~cynetworkx.algorithms.matching.is_maximal_matching` function.
...
class TestMaximalMatching(object):
    """Unit tests for the
    :func:`~cynetworkx.algorithms.matching.maximal_matching`.
