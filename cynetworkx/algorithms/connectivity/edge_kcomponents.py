...
from cynetworkx.algorithms import bridges
...
def bridge_components(G):
    ...
    >>> from cynetworkx.algorithms.connectivity.edge_kcomponents import bridge_components
...
class EdgeComponentAuxGraph(object):
    ...
    >>> import itertools as it
    >>> from cynetworkx.utils import pairwise
    >>> from cynetworkx.algorithms.connectivity import EdgeComponentAuxGraph
