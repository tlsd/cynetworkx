...
def bridges(G, root=None):
    ...
    using the :func:`cynetworkx.chain_decomposition` function.

    Ignoring polylogarithmic factors, the worst-case time complexity is the
    same as the :func:`cynetworkx.chain_decomposition` function,
...
def has_bridges(G, root=None):
    ...
    Notes
    -----
    This implementation uses the :func:`cynetworkx.bridges` function, so
