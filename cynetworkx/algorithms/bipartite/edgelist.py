...
from cynetworkx.utils import open_file, make_str, not_implemented_for
...
def read_edgelist(path, comments="#",
    ...
    create_using : Graph container, optional,
       Use specified container to build graph.  The default is cynetworkx.Graph,
       an undirected graph.
    ...
    -------
    G : graph
       A cynetworkx Graph or other type specified with create_using
