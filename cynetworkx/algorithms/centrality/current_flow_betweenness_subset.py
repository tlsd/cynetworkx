...
from cynetworkx.algorithms.centrality.flow_matrix import *
from cynetworkx.utils import not_implemented_for, reverse_cuthill_mckee_ordering
...
def current_flow_betweenness_centrality_subset(G, sources, targets,
    ...
    """
    from cynetworkx.utils import reverse_cuthill_mckee_ordering
    try:
        import numpy as np
    except ImportError:
