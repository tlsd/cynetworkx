...
from cynetworkx.algorithms.community.quality import modularity

from cynetworkx.utils.mapped_queue import MappedQueue
...
def greedy_modularity_communities(G, weight=None):
    ...
    Examples
    --------
    >>> from cynetworkx.algorithms.community import greedy_modularity_communities
