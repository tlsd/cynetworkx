...
from cynetworkx.algorithms.community import label_propagation_communities
from cynetworkx.algorithms.community import asyn_lpa_communities
...
class TestAsynLpaCommunities(object):
    def _check_communities(self, G, expected):
        ...
        using the :func:`~cynetworkx.asyn_lpa_communities` function match
