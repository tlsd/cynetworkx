...
# information.
"""Unit tests for the :mod:`cynetworkx.algorithms.community.generators`
module.
...
from cynetworkx.algorithms.community import LFR_benchmark_graph
from cynetworkx.algorithms.community.community_utils import is_partition
