...
# information.
"""Unit tests for the :mod:`cynetworkx.algorithms.community.centrality`
module.
...
from cynetworkx.algorithms.community import girvan_newman
...
class TestGirvanNewman(object):
    """Unit tests for the
    :func:`cynetworkx.algorithms.community.centrality.girvan_newman`
    function.
