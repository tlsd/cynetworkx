...
from cynetworkx.testing import assert_graphs_equal
...
class TestConvertNumpy(object):
    ...
    def test_from_scipy_sparse_matrix_parallel_edges(self):
        """Tests that the :func:`cynetworkx.from_scipy_sparse_matrix` function
    ...
    def test_symmetric(self):
        ...
        :func:`cynetworkx.from_scipy_sparse_matrix`.
