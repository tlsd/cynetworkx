...
#:
#:     import gzip
#:     from cynetworkx.generators.atlas import graph_atlas_g
#:     from cynetworkx.readwrite.edgelist import write_edgelist
#:
...
def graph_atlas(i):
    ...
    -------
    list
        A list of :class:`~cynetworkx.Graph` objects, the one at index *i*
