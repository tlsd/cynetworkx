...
from cynetworkx.utils import random_weighted_sample
...
def _configuration_model(deg_sequence, create_using, directed=False,
    ...
    on this keyword argument, see :func:`~cynetworkx.empty_graph`.
...
def configuration_model(deg_sequence, create_using=None, seed=None):
    ...
    :mod:`~cynetworkx.utils.random_sequence` (or one of your own). For
