...
"""Unit tests for the :mod:`cynetworkx.generators.expanders` module.
...
from cynetworkx import adjacency_matrix
from cynetworkx import number_of_nodes
from cynetworkx.generators.expanders import chordal_cycle_graph
from cynetworkx.generators.expanders import margulis_gabber_galil_graph
...
def test_chordal_cycle_graph():
    """Test for the :func:`cynetworkx.chordal_cycle_graph` function."""
