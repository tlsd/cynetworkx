...
from cynetworkx.generators.geometric import euclidean
...
class TestRandomGeometricGraph(object):
    """Unit tests for the :func:`~cynetworkx.random_geometric_graph`
    function.
...
class TestSoftRandomGeometricGraph(object):
    """Unit tests for the :func:`~cynetworkx.soft_random_geometric_graph`
    function.
...
class TestGeographicalThresholdGraph(object):
    """Unit tests for the :func:`~cynetworkx.geographical_threshold_graph`
    function.
...
class TestWaxmanGraph(object):
    """Unit tests for the :func:`~cynetworkx.waxman_graph` function."""
...
class TestThresholdedRandomGeometricGraph(object):
    """Unit tests for the :func:`~cynetworkx.thresholded_random_geometric_graph`
    function.
