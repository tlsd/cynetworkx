...
# information.
"""Unit tests for the :mod:`cynetworkx.generators.duplication` module.
...
from cynetworkx.generators.duplication import duplication_divergence_graph
from cynetworkx.generators.duplication import partial_duplication_graph


class TestDuplicationDivergenceGraph(object):
    """Unit tests for the
    :func:`cynetworkx.generators.duplication.duplication_divergence_graph`
    function.
...
class TestPartialDuplicationGraph(object):
    """Unit tests for the
    :func:`cynetworkx.generators.duplication.partial_duplication_graph`
    function.
