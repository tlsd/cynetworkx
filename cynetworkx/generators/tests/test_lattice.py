"""Unit tests for the :mod:`cynetworkx.generators.lattice` module."""
...
from cynetworkx.testing import assert_edges_equal


class TestGrid2DGraph:
    """Unit tests for :func:`cynetworkx.generators.lattice.grid_2d_graph`"""
...
class TestGridGraph:
    """Unit tests for :func:`cynetworkx.generators.lattice.grid_graph`"""
...
class TestHypercubeGraph:
    """Unit tests for :func:`cynetworkx.generators.lattice.hypercube_graph`"""
...
class TestTriangularLatticeGraph:
    "Tests for :func:`cynetworkx.generators.lattice.triangular_lattice_graph`"
...
class TestHexagonalLatticeGraph:
    "Tests for :func:`cynetworkx.generators.lattice.hexagonal_lattice_graph`"
