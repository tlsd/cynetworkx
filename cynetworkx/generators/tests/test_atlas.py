...
from cynetworkx import graph_atlas
from cynetworkx import graph_atlas_g
from cynetworkx.generators.atlas import NUM_GRAPHS
from cynetworkx.utils import pairwise


class TestAtlasGraph(object):
    """Unit tests for the :func:`~cynetworkx.graph_atlas` function."""
...
class TestAtlasGraphG(object):
    """Unit tests for the :func:`~cynetworkx.graph_atlas_g` function."""
