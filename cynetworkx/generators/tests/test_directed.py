...
from cynetworkx.classes import MultiDiGraph
from cynetworkx.generators.directed import gn_graph
from cynetworkx.generators.directed import gnr_graph
from cynetworkx.generators.directed import gnc_graph
from cynetworkx.generators.directed import random_k_out_graph
from cynetworkx.generators.directed import random_uniform_k_out_graph
from cynetworkx.generators.directed import scale_free_graph
...
class TestRandomKOutGraph(object):
    """Unit tests for the
    :func:`~cynetworkx.generators.directed.random_k_out_graph` function.
...
class TestUniformRandomKOutGraph(object):
    """Unit tests for the
    :func:`~cynetworkx.generators.directed.random_uniform_k_out_graph`
    function.
