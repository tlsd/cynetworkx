...
Generates a cynetworkx.DiGraph from point and line shapefiles.
...
def read_shp(path, simplify=True, geom_attrs=True, strict=True):
    """Generates a cynetworkx.DiGraph from shapefiles. Point geometries are
...
def edges_from_line(geom, attrs, simplify=True, geom_attrs=True):
    ...
    -------
     edges:  generator of edges
        ...
        suitable for expanding into a cynetworkx Graph add_edge call
    """
    try:
        from osgeo import ogr
    except ImportError:
...
def write_shp(G, outdir):
    """Writes a cynetworkx.DiGraph to two shapefiles, edges and nodes.
