...
These are not imported into the base cynetworkx namespace but
can be accessed, for example, as

>>> import cynetworkx
>>> cynetworkx.utils.is_string_like('spam')
True
"""
...
# see G.add_nodes and others in Graph Class in cynetworkx/base.py
...
def groups(many_to_one):
    ...
    For example::
        ...
        >>> from cynetworkx.utils import groups
...
def to_tuple(x):
    ...
    For example::
        ...
        >>> from cynetworkx.utils import to_tuple
        >>> a_list = [1, 2, [1, 4]]
        >>> to_tuple(a_list)
        (1, 2, (1, 4))
