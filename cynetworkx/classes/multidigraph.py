...
from cynetworkx.classes.graph import Graph  # for doctests
from cynetworkx.classes.digraph import DiGraph
from cynetworkx.classes.multigraph import MultiGraph
from cynetworkx.classes.coreviews import MultiAdjacencyView
from cynetworkx.classes.reportviews import OutMultiEdgeView, InMultiEdgeView, \
...
class MultiDiGraph(MultiGraph, DiGraph):
    ...
    incoming_graph_data : input graph (optional, default: None)
        ...
        by the to_cynetworkx_graph() function, currently including edge list,
    ...
    **Subclasses (Advanced):**
    ...
    Please see :mod:`~cynetworkx.classes.ordered` for examples of
