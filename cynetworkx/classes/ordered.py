...
class OrderedGraph(Graph):
    """Consistently ordered variant of :class:`~cynetworkx.Graph`."""
...
class OrderedDiGraph(DiGraph):
    """Consistently ordered variant of :class:`~cynetworkx.DiGraph`."""
    node_dict_factory = OrderedDict
    adjlist_outer_dict_factory = OrderedDict
    adjlist_inner_dict_factory = OrderedDict
    edge_attr_dict_factory = OrderedDict
...
class OrderedMultiGraph(MultiGraph):
    """Consistently ordered variant of :class:`~cynetworkx.MultiGraph`."""
    node_dict_factory = OrderedDict
    adjlist_outer_dict_factory = OrderedDict
    adjlist_inner_dict_factory = OrderedDict
...
class OrderedMultiDiGraph(MultiDiGraph):
    """Consistently ordered variant of :class:`~cynetworkx.MultiDiGraph`."""
    node_dict_factory = OrderedDict
    adjlist_outer_dict_factory = OrderedDict
    adjlist_inner_dict_factory = OrderedDict
    edge_key_dict_factory = OrderedDict
