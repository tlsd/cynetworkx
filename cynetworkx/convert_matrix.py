...
>>> D = nx.to_cynetworkx_graph(a, create_using=nx.DiGraph())
...
from cynetworkx.convert import _prep_create_using
...
def from_numpy_matrix(A, parallel_edges=False, create_using=None):
    ...
    Notes
    -----
    If `create_using` is an instance of :class:`cynetworkx.MultiGraph` or
    :class:`cynetworkx.MultiDiGraph`, `parallel_edges` is True, and the
